        ...
        login(email, password)
            .then(response => {
                if (response.data){
                  ...
                  console.error("Erro ao processar a resposta");
                }
            })
            .catch(error => {
                console.error('Falha no login:', error); // Mandar Alerta
            });
    } else {
        console.error('Email ou senha estão ausentes ou inválidos.'); // Mandar Alerta
    }
  };
